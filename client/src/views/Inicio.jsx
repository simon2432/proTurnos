...
function Inicio() {
    ...
    const handleRegister = () => {
        ...
        .then(data => {
            ...
            alert(`Se registró correctamente el ${formType === 'cliente' ? 'cliente' : 'especialista'}`);
            // Aquí puedes agregar algún manejo adicional, como redirigir a otra página
        })
        .catch((error) => {
    ...
    const handleLogin = () => {
        ...
        .then(data => {
            if (data.success) {
                ...
                const perfilRoute = data.user.tipo_usuario === 'cliente' ? '/PerfilC' : '/PerfilE';
    ...
    return (
        <div className='cuerpo-inicio'>
            <div className='menu'>
                <img src='/fotosApp/logoCarePlaner.png' alt='Care Planner Logo' className="logo" />
                {!showForm && (
                    <>
                        <input 
                            type="email" 
                ...
                <button onClick={toggleRegister}>{showForm ? 'Close Register' : 'Register'}</button>
                {showForm && (
                    <div className='register-form'>
                        <button onClick={() => setFormType('cliente')}>Cliente</button>
                        <button onClick={() => setFormType('especialista')}>Especialista</button>
